...
public class UsaActivitatOnline {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LocalDate iniciInscripcio = LocalDate.of(2025, 9, 1);
            LocalDate fiInscripcio = LocalDate.of(2025, 9, 15);
            LocalDate dataIniciActivitat = LocalDate.of(2025, 10, 1);
            ...
            LocalDate diaInscripcio = LocalDate.of(2025, 9, 10); // Dins termini
            ...
            LocalDate diaActivitat = LocalDate.of(2025, 10, 5); // Dins dels 30 dies
            ...
            LocalDate diaTard = LocalDate.of(2025, 12, 1); // Passats els 30 dies
